...
var require_pilogger = __commonJS({
  "node_modules/.pnpm/@vladmandic+pilogger@0.4.2/node_modules/@vladmandic/pilogger/dist/pilogger.js"(exports) {
    ...
    var os2 = __toModule(__require("os"));
    var fs8 = __toModule(__require("fs"));
    var path4 = __toModule(__require("path"));
    ...
    var import_node_os = __toModule(__require("os"));
    var import_node_tty = __toModule(__require("tty"));
    ...
    var import_console = __toModule(__require("console"));
