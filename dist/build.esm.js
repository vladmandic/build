...
var require_git = __commonJS({
  "node_modules/.pnpm/simple-git@2.45.1/node_modules/simple-git/src/git.js"(exports, module) {
...
var require_promise = __commonJS({
  "node_modules/.pnpm/simple-git@2.45.1/node_modules/simple-git/promise.js"(exports, module) {
    var { esModuleFactory, gitExportFactory } = require_git_factory();
    var { gitP } = require_promise_wrapped();
    module.exports = esModuleFactory(gitExportFactory(gitP));
  }
});
...
var require_compile = __commonJS({
  "src/compile.js"(exports, module) {
    var log = require_pilogger();
    var esbuild = __require("esbuild");
    ...
    async function run(config, steps) {
      ...
      for (const entry of config.build.targets) {
        ...
        const options = helpers.merge(defaults, config.build.global, entry);
        options.metafile = true;
        delete options.input;
        delete options.output;
        delete options.name;
        delete options.typings;
        delete options.typedoc;
...
var require_anymatch = __commonJS({
  "node_modules/.pnpm/anymatch@3.1.2/node_modules/anymatch/index.js"(exports, module) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var picomatch = require_picomatch2();
...
var require_is_glob = __commonJS({
  "node_modules/.pnpm/is-glob@4.0.1/node_modules/is-glob/index.js"(exports, module) {
...
var require_nodefs_handler = __commonJS({
  "node_modules/.pnpm/chokidar@3.5.2/node_modules/chokidar/lib/nodefs-handler.js"(exports, module) {
    "use strict";
    var fs = __require("fs");
    var sysPath = __require("path");
    var { promisify } = __require("util");
...
var require_fsevents_handler = __commonJS({
  "node_modules/.pnpm/chokidar@3.5.2/node_modules/chokidar/lib/fsevents-handler.js"(exports, module) {
    "use strict";
    var fs = __require("fs");
    var sysPath = __require("path");
    var { promisify } = __require("util");
...
var require_sync = __commonJS({
  "node_modules/.pnpm/glob@7.1.7/node_modules/glob/sync.js"(exports, module) {
...
var require_glob = __commonJS({
  "node_modules/.pnpm/glob@7.1.7/node_modules/glob/glob.js"(exports, module) {
    module.exports = glob;
    var fs = __require("fs");
    var rp = require_fs();
    var minimatch = require_minimatch();
  ...
  "src/clean.js"(exports) {
    ...
    function run(config) {
      ...
      if (!config.clean.locations)
        log.warn("Clean called, but locations are not set");
      else
...
var require_commander = __commonJS({
  "node_modules/.pnpm/commander@8.2.0/node_modules/commander/index.js"(exports, module) {
    ...
    var Build = class {
      constructor(options = {}) {
        ...
        if (this.config.log.enabled && this.config.log.output && this.config.log.output !== "")
          log.logFile(this.config.log.output);
      }
      async run(profile, options = {}) {
        ...
        for (const step of steps) {
          switch (step) {
            case "clean":
              await clean.run(this.config);
              break;
            case "compile":
              await compile.run(this.config, steps);
              break;
            case "lint":
              await lint.run(this.config);
              break;
            case "changelog":
              await changelog.run(this.config, packageJson);
              break;
            case "serve":
            ...
            case "typedoc":
              break;
            default:
              log.warn("Build: unknown step", step);
          }
        }
